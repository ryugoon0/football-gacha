...
export const PATCH_LOG: PatchEntry[] = [
  ...
  },
  {
    ...
    date: '2026-09-07',
    kind: 'feature',
    title: '리미티드 1차 「9월 1주 MOM」 20장 — 9월 8일(화) 14:00부터 일주일',
    detail: [
      ...
      '9월 8일(화) 14:00 ~ 15일(화) 13:59에만 리미티드 스카우트(프리미엄 자리)의 리미티드 칸에서 나오고, 그 주 픽업도 이 카드들 중 하나입니다. 기간이 끝나면 풀에서 빠지고 받은 카드는 남습니다. 앨범에 「리미티드 · 9월 1주 MOM」 특별 세트가 생깁니다.',
    ],
  },
  {
