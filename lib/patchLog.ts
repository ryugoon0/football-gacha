...
export const PATCH_LOG: PatchEntry[] = [
  ...
  },
  {
    ...
    date: '2026-09-07',
    kind: 'feature',
    title: '리미티드 1차 「9월 1주 MOM」 13장 — 9월 8일(화) 14:00부터 일주일',
    detail: [
      '9월 4~6일 실제 경기의 활약 선수 13장이 리미티드 카드로 나옵니다. 정규 카드와 같은 이름·같은 선수이며, 서로 한계 돌파 재료가 됩니다. 발렌시아 원정 0-5의 2골(라민 야멀 92)과 1골 2도움(페르민 로페노 88), 오사수나전 해트트릭(루카스 보옌 83), 첼시전 결승골(마르틴 외데가르 89), 풀럼전 2골 풀백(타이릭 미첼런 84), 빌라전 무실점 골키퍼(콘스탄티노스 촐라키손 78), 아탈란타전 추가시간 결승골(마티아스 술렌 84), 나폴리전 3-2 역전 결승골(라우타로 마르티네손 90), 함부르크 원정 2골(필리프 티추 79), 프랑크푸르트 원정 역전 마무리 프리킥(파비안 리더스 78), 마르세유 원정 해트트릭(라신 시나요콘 80), 트루아 원정 2골(샘 아모아메야운 76), PSG 원정 결승골(스타니스 이둠본 78).',
