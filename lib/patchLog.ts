...
export const PATCH_LOG: PatchEntry[] = [
  {
    ...
    date: '2026-09-06',
    kind: 'feature',
    title: '[예고] 9월 8일(월) 오후 2시 「9월 1주 MOM」 리미티드 카드 — 일주일 한정',
    detail: [
      '9월 1일~7일 실제 경기에서 맨 오브 더 매치로 뽑힌 선수들이 그 주 활약 능력치의 리미티드 카드로 나옵니다.',
      '9월 8일(월) 오후 2시부터 9월 15일(월) 오후 1시 59분까지, 프리미엄 스카우트에서만 나옵니다. 기간 중에는 「이번 주 픽업」 자리에 올라 같은 등급이 나올 때 절반이 리미티드 카드입니다.',
