...
export const PATCH_LOG: PatchEntry[] = [
  {
    ...
    detail: [
      '9월 4~6일 실제 경기의 활약 선수 13장이 리미티드 카드로 나옵니다. 발렌시아 원정 0-5의 2골(라민 야마르 92)과 1골 2도움(페르민 로페시 88), 오사수나전 해트트릭(루카스 보에 83), 첼시전 결승골(마르틴 외데고르 89), 풀럼전 2골 풀백(타이릭 미셸 84), 빌라전 무실점 골키퍼(콘스탄티노스 촐라키 78), 아탈란타전 추가시간 결승골(마티아스 술레이 84), 나폴리전 3-2 역전 결승골(라우타로 마르티노 90), 함부르크 원정 2골(필리프 티에츠 79), 프랑크푸르트 원정 역전 마무리 프리킥(파비안 리데르 78), 마르세유 원정 해트트릭(라신 시나요쿠 80), 트루아 원정 2골(샘 아모아메요 76), PSG 원정 결승골(스타니스 이둠부 78).',
