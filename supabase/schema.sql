...
-- ---------------------------------------------------------------------------
-- 13. 정식 주간 시즌(9/7 첫 주) 자동 생성 (docs/WEEKLY_TOURNAMENT.md)
-- ---------------------------------------------------------------------------
-- 배치 리그와 같은 원칙 — 대진 패턴은 클럽이 누구인지와 무관하게 항상
-- 같으므로 실제 출력을 정적 표로 저장해 두고 조인만 한다. 첫 주는 배치
-- 리그에 승격·강등이 없었으므로 그 등급 구성을 그대로 이어받는다 —
-- 2주차부터 필요한 승격·강등 반영 로직은 범위 밖(2026-09-14 즈음 필요).
