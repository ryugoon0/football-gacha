...
const STEPS: Step[] = [
  ...
  },
  {
    tab: 'gacha',
    title: '1. 선수를 모읍니다',
    body: '스카우트는 일반과 프리미엄 두 종류이고, 각각 1명과 10연속이 있습니다. 일반은 바로 공개되고, 프리미엄은 후보 카드가 가로로 돌다 한 명에서 멈추는 룰렛 연출로 한 명씩 공개됩니다 — 판이 금빛으로 바뀌면 골드 이상이 확정된 것이고, 플래티넘 이상 후보가 옆에 섞여 어디서 멈출지 끝까지 알 수 없습니다. 프리미엄은 비싼 대신 고급 카드 확률이 훨씬 높고 10연속에는 골드 이상이 보장됩니다. 하루 한 번은 무료이고, 30회 안에 골드 이상이 반드시 나옵니다(천장). 카드 등급은 일반 · 실버 · 골드 · 플래티넘 · 월드 순이고, 등급마다 시작 레벨과 성장 상한이 다릅니다. 월드는 과거 시즌에 리그를 지배한 레전드를 당시 팀·당시 시즌으로 낸 카드입니다.',
  },
  {
    tab: 'squad',
    title: '2. 스쿼드를 짭니다',
  ...
  },
  {
    tab: 'club',
    title: '3. 선수를 키웁니다',
    body: '카드를 누르면 가능 포지션과 세부 능력치를 볼 수 있습니다. 성장은 두 가지입니다. ①훈련: 다른 카드를 재료로 먹여 경험치를 쌓아 레벨업. ②한계 돌파: 같은 선수 카드 1장을 소모해 레벨 한계를 1 올림. 키울 선수는 선발이어도 되고, 재료로 넣는 카드만 선발·벤치에서 빼면 됩니다. 등급별 상한은 일반 8 · 실버 9 · 골드/플래티넘/월드 10이고, 10레벨이면 주요 능력치가 99가 됩니다. 카드 한 장이 보관함 한 칸을 쓰고, 골드로 +10칸씩 최대 200칸까지 늘릴 수 있습니다. 같은 99라도 보이지 않는 히든 능력치 때문에 골드보다 플래티넘이, 플래티넘보다 월드가 강합니다.',
  },
  {
    tab: 'match',
    title: '4. 리그와 컵을 뜁니다',
    body: '20개 팀이 겨루는 리그 19라운드와 FA컵 4라운드가 한 일정에 섞여 있습니다. 경기일 순서대로 치르며, 2위 안이면 승격 · 18위 아래면 강등입니다. 컵은 지면 그 시즌은 끝입니다. 경기는 선수들이 움직이는 관전 모드와 중계 문구만 보는 텍스트 모드로 볼 수 있고, 경기 중에는 화면 아래 고정 바에서 전술 프리셋과 교체를 누르면 됩니다. 선발은 뛸수록 체력이 떨어지고 팀 전력도 같이 내려가니, 후반에는 지친 선수 교체 버튼으로 벤치를 쓰세요. 지시는 언제든 내릴 수 있고, 파울 · 골 · 아웃 · 하프타임처럼 경기가 멈춘 순간에 실제로 반영됩니다. 연전이 이어지니 벤치와 자동 교체로 체력을 관리하세요. 순위와 상관없는 친선 경기(데일리 미니게임)는 미니게임 탭에서 하루 10판까지 바로 칠 수 있고, 체력도 쓰지 않습니다.',
  },
]
