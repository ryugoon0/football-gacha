...
const STEPS: Step[] = [
  ...
  },
  {
    tab: 'gacha',
    title: '1. 선수를 모읍니다',
    body: '스카우트는 일반과 프리미엄 두 종류이고, 각각 1명과 10연속이 있습니다. 일반은 바로 공개되고, 프리미엄은 후보 카드가 가로로 돌다 한 명에서 멈추는 룰렛 연출로 한 명씩 공개됩니다 — 판이 금빛으로 바뀌면 후보에 라이브 이상이 섞여 있다는 뜻입니다. 프리미엄은 비싼 대신 고급 카드 확률이 훨씬 높고 10연속에는 골드 이상이 보장됩니다. 하루 한 번은 무료이고, 30회 안에 골드 이상이 반드시 나옵니다(천장). 카드 등급은 일반 · 실버 · 골드 · 라이브 · 레전드 순이고, 등급마다 시작 레벨과 성장 상한이 다릅니다.',
  },
  {
    tab: 'squad',
    title: '2. 스쿼드를 짭니다',
