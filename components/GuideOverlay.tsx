...
const STEPS: Step[] = [
  ...
  },
  {
    tab: 'squad',
    title: '2. 스쿼드를 짭니다',
    body: '자리를 눌러 선수를 배치하고 벤치도 채우세요. 가능 포지션이 아닌 자리에 넣으면 능력치가 크게 깎입니다. 선발과 후보 18명 중 같은 클럽 8명·같은 리그나 국가 11명이면 팀 컬러가 발동하고, 18명 전원이 같은 클럽이면 최고 단계입니다. 리그마다 선발 11명의 레벨 합 상한이 있어(5부 55 → 1부 110) 상한을 넘으면 경기에 등록할 수 없습니다. 바꾼 라인업은 「현재 라인업 저장」을 눌러야 남고, 저장하지 않고 나가면 원래대로 돌아갑니다. 라인업은 3개까지 보관해 두고 바꿔 쓸 수 있습니다.',
  },
  {
    tab: 'tactics',
    title: '3. 전술을 정합니다',
    body: '전술 탭에서 총공세 · 균형 · 역습 · 잠그기 프리셋을 한 번에 고르거나, 플랜 · 압박 · 수비 라인 · 템포를 따로 정합니다. 자동 교체를 켜면 부상·체력 저하 선수를 킥오프 전에 벤치와 바꿔줍니다. 세부 조정 슬라이더로 상황별 지시까지 손볼 수 있습니다.',
  },
  {
    tab: 'club',
    title: '4. 선수를 키웁니다',
