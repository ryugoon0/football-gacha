...
const STEPS: Step[] = [
  ...
  },
  {
    tab: 'club',
    title: '3. 선수를 키웁니다',
    body: '카드를 누르면 가능 포지션과 세부 능력치를 볼 수 있습니다. 성장은 두 가지입니다. ①훈련: 다른 카드를 재료로 먹여 경험치를 쌓아 레벨업. ②한계 돌파: 같은 선수 카드 1장을 소모해 레벨 한계를 1 올림. 키울 선수는 선발이어도 되고, 재료로 넣는 카드만 선발·벤치에서 빼면 됩니다. 등급별 상한은 일반 8 · 실버 9 · 골드/라이브/월드 10이고, 10레벨이면 주요 능력치가 99가 됩니다. 카드 한 장이 보관함 한 칸을 쓰고, 골드로 +10칸씩 최대 200칸까지 늘릴 수 있습니다. 같은 99라도 보이지 않는 히든 능력치 때문에 골드보다 라이브가 강합니다.',
  },
  {
    tab: 'market',
    title: '4. 원하는 선수를 삽니다',
