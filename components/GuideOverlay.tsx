...
const STEPS: Step[] = [
  ...
  },
  {
    tab: 'squad',
    title: '2. 스쿼드를 짭니다',
    body: '자리를 눌러 선수를 배치하고 벤치도 채우세요. 가능 포지션이 아닌 자리에 넣으면 능력치가 크게 깎입니다. 같은 클럽 3명·같은 리그나 국가 5명이면 팀 컬러가 발동합니다. 리그마다 선발 11명의 레벨 합 상한이 있어(5부 55 → 1부 110) 상한을 넘으면 경기에 등록할 수 없습니다. 자동 교체를 켜면 부상·체력 저하 선수를 킥오프 전에 벤치와 바꿔줍니다. 전술은 플랜(1 2 3) · 압박(Q W E) · 수비 라인(A S D) · 템포(Z X C) 네 가지를 따로 정하고, 같은 단축키로 경기 중에도 바꿉니다.',
  },
  {
    tab: 'club',
    title: '3. 선수를 키웁니다',
  ...
  },
  {
    tab: 'match',
    title: '5. 리그와 컵을 뜁니다',
    body: '20개 팀이 겨루는 리그 19라운드와 FA컵 4라운드가 한 일정에 섞여 있습니다. 경기일 순서대로 치르며, 2위 안이면 승격 · 18위 아래면 강등입니다. 컵은 지면 그 시즌은 끝입니다. 경기는 선수들이 움직이는 관전 모드와 중계 문구만 보는 텍스트 모드로 볼 수 있고, 교체와 전술 지시는 언제든 내릴 수 있고, 파울 · 골 · 아웃 · 하프타임처럼 경기가 멈춘 순간에 실제로 반영됩니다(Space로 직접 멈출 수도 있습니다). 연전이 이어지니 벤치와 자동 교체로 체력을 관리하세요.',
  },
]
