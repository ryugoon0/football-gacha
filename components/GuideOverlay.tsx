...
const STEPS: Step[] = [
  ...
  },
  {
    tab: 'gacha',
    title: '1. 선수를 모읍니다',
    body: '스카우트는 일반과 프리미엄 두 종류이고, 각각 1명과 10연속이 있습니다. 일반은 바로 공개되고, 프리미엄은 후보 카드가 가로로 돌다 한 명에서 멈추는 룰렛 연출로 한 명씩 공개됩니다 — 판이 금빛으로 바뀌면 골드 이상이 확정된 것이고, 라이브 이상 후보가 옆에 섞여 어디서 멈출지 끝까지 알 수 없습니다. 프리미엄은 비싼 대신 고급 카드 확률이 훨씬 높고 10연속에는 골드 이상이 보장됩니다. 하루 한 번은 무료이고, 30회 안에 골드 이상이 반드시 나옵니다(천장). 카드 등급은 일반 · 실버 · 골드 · 라이브 · 레전드 순이고, 등급마다 시작 레벨과 성장 상한이 다릅니다.',
  },
  {
    tab: 'squad',
    title: '2. 스쿼드를 짭니다',
  ...
  },
  {
    tab: 'club',
    title: '3. 선수를 키웁니다',
    body: '카드를 누르면 가능 포지션과 세부 능력치를 볼 수 있습니다. 성장은 두 가지입니다. ①훈련: 다른 카드를 재료로 먹여 경험치를 쌓아 레벨업. ②한계 돌파: 같은 선수 카드 1장을 소모해 레벨 한계를 1 올림. 키울 선수는 선발이어도 되고, 재료로 넣는 카드만 선발·벤치에서 빼면 됩니다. 등급별 상한은 일반 8 · 실버 9 · 골드/라이브/레전드 10이고, 10레벨이면 주요 능력치가 99가 됩니다. 카드 한 장이 보관함 한 칸을 쓰고, 골드로 +10칸씩 최대 200칸까지 늘릴 수 있습니다. 같은 99라도 보이지 않는 히든 능력치 때문에 골드보다 라이브가 강합니다.',
  },
  {
    tab: 'match',
    title: '4. 리그와 컵을 뜁니다',
