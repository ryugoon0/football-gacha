    ...
    <div className="space-y-6">
      ...
      <section className="panel p-4">
        ...
        <p className="mt-2 text-[11px] leading-relaxed text-slate-500">
          같은 등급 안에서는 그 등급의 모든 현역 카드가 같은 확률로 나옵니다. 월드 카드는 월드 스카우트와 프리미엄(리미티드) 스카우트에서만 나오고 일반 스카우트에서는 나오지 않습니다. 리미티드 카드는
      ...
      <section className="panel p-4">
        ...
        <ul className="mt-3 space-y-1.5 text-[12px] leading-relaxed text-slate-300">
          ...
          <li>
            <b className="text-white">월드 스카우트</b>: 골드로는 팔지 않습니다. 월드 스카우트팩은 선물, 월드 카드 3장 합성, 또는 조각 {tune('worldShardCost')}개로 열 수 있고, 열면 위 표의 「월드 스카우트」 열대로
            플래티넘 아니면 월드가 나옵니다.
          </li>
          <li>
